...
export default class FluroAsset {
   ...
   * @example
   * // 'https://api.this.Fluro.io/get/5be504eabf33991239599d63'
   * Fluro.asset.getUrl('5be504eabf33991239599d63')
   *
   * // 'https://api.this.Fluro.io/get/5be504eabf33991239599d63/file/MyFile.pdf'
   * Fluro.asset.getUrl('5be504eabf33991239599d63', {filename:'MyFile.pdf'})
   */
  getUrl(assetID, params) {
    // Get the asset id as a pure string
    assetID = this.Fluro.utils.getStringID(assetID)
    ...
    let url = `${this.Fluro.apiURL}/get/${assetID}`
   ...
   * @return {string}         A valid Fluro URL
   * @example
   * // 'https://api.this.Fluro.io/get/player?url=https://api.this.Fluro.io/get/5be504eabf33991239599d63'
   * Fluro.asset.playerUrl('5be504eabf33991239599d63')
   */
  playerUrl(videoID, params) {
    // Get the asset id as a pure string
    videoID = this.Fluro.utils.getStringID(videoID)
    ...
    let url = `${this.Fluro.apiURL}/get/player?url=${this.Fluro.apiURL}/get/${videoID}`
   ...
   * @example
   * // 'https://api.this.Fluro.io/get/avatar/contact/5be504eabf33991239599d63?w=100&h=100'
  ...
  avatarUrl(personID, style, params) {
    ...
    personID = this.Fluro.utils.getStringID(personID)
    ...
    let url = `${this.Fluro.apiURL}/get/avatar/${style}/${personID}`
   ...
   * @return {string}          A full URL that links to the image the user is requesting
   * @example
   * // returns 'https://api.this.Fluro.io/get/event/5be504eabf33991239599d63?w=100&h=100'
  ...
  coverUrl(contentID, style, params) {
    // Get the id as a pure string
    contentID = this.Fluro.utils.getStringID(contentID)
    ...
    let url = `${this.Fluro.apiURL}/get/${style}/${contentID}`
   ...
   * @example
   * // returns 'https://api.this.Fluro.io/download/5be504eabf33991239599d63'
   * Fluro.asset.downloadUrl('5be504eabf33991239599d63')
   *
   * // returns 'https://api.this.Fluro.io/download/5be504eabf33991239599d63/file/MyFile.docx'
  ...
  downloadUrl(assetID, params) {
    ...
    let url = `${this.Fluro.apiURL}/download/${assetID}`
   ...
   * @example
   * // returns 'https://api.this.Fluro.io/get/poster/5be504eabf33991239599d63?w=1920&h=1080'
   * Fluro.asset.posterUrl('5be504eabf33991239599d63', 1920, 1080)
   *
   * // returns 'https://api.this.Fluro.io/get/poster/5be504eabf33991239599d63/file/file.jpg?w=1920&h=1080'
   ...
   * // returns 'https://api.this.Fluro.io/get/poster/5be504eabf33991239599d63/file/MyPoster.jpg?w=1920&h=1080'
  ...
  posterUrl(videoID, w, h, params) {
    ...
    let url = `${this.Fluro.apiURL}/get/${videoID}/poster`
   ...
   * @param  {Integer} width The width of the image to retrieve from this.Fluro. If none is specified then will default to a size based on the requesting user's screen dimensions.
   * @param  {Integer} height The height of the image to retrieve from this.Fluro. If none is specified then will default to a size based on the requesting user's screen dimensions.
   * @param  {object} params
   ...
   * @example
   * // returns 'https://api.this.Fluro.io/get/5be504eabf33991239599d63?w=800'
   * Fluro.asset.imageUrl('5be504eabf33991239599d63', 800)
   *
   * // returns 'https://api.this.Fluro.io/get/5be504eabf33991239599d63/file/image.jpg?w=800'
   * Fluro.asset.imageUrl('5be504eabf33991239599d63', 800, null, {filename:'MyFile.pdf'})
   */
  // Helper function for retrieving the poster image for a video
  imageUrl(imageID, w, h, params) {
    // Get the id as a pure string
    imageID = this.Fluro.utils.getStringID(imageID)
    ...
    // Create the basic url
    let url = this.Fluro.apiURL + '/get/' + imageID
    // Setup our usual width limit
    let limitWidth
    // By default, limit the width
    if (this.isRetina) {
